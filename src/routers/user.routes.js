 ...
 */
userRouter.post("/post", userController.postUser); // ----postuser
 ...
 *        description: Server xatosi!
 */
userRouter.get("/get", userController.getUser); // ----getUser
 ...
 *        description: Server xatosi!
 */
userRouter.get("/search", userController.searchUser); // ----searchUser
 ...
 *        description: Server xatosi!
 */
userRouter.get("/getById/:id", userController.getUserById); // ----getUserById
 ...
 *        description: Server xatosi!
 */
userRouter.put("/update/:id", userController.updateUser); // ----updateUser
 ...
 *        description: Server xatosi!
 */
userRouter.delete("/delete/:id", userController.deleteUser); // ----deleteUser
